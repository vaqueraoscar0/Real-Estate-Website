    ...
    useEffect(() => {
        if (state.sendRequest) {
            async function AddProperty() {
                ...
                try {
                    await Axios.post(
                        "https://listingbuddy-d88c1ed5b70e.herokuapp.com/api/listings/create/",
                        formData
                    );
        ...
        >
            <form onSubmit={FormSubmit}>
                <Grid item container justifyContent="center">
                    <Typography variant="h5" fontWeight={500}>SUBMIT A PROPERTY</Typography>
                </Grid>

                <Grid item container sx={{ marginTop: "3rem" }}>
                    <TextField
                        id="title"
                        label="Title*"
                        variant="standard"
                ...
                <Grid item container justifyContent="space-between" marginTop={3}>
                ...
                {state.listingTypeValue === "Office" ? (
                    ...
                    <Grid item xs={3} container sx={{ marginTop: "3rem" }}>
                        <TextField
                            id="rooms"
                            label="Rooms"
                            type="number"
                ...
                <Grid item container justifyContent="space-between" marginTop={5}>
                ...
                <Grid item container xs={4} style={{marginTop: '5rem'}}>
                    <Typography variant={'standard'} fontSize={20} marginBottom={2}>Images: </Typography>
                    <Button variant={'contained'} component={'label'} style={{height: "40px", backgroundColor: 'transparent', border: '1px solid grey', color: 'black'}} fullWidth>
                    ...
                    {/*<TextField onChange={(e) => dispatch({type: 'catchPicture1Change', picture1Chosen: e.target.value})} id="picture1" label="Picture1" variant="standard" fullWidth/>*/}
                </Grid>
