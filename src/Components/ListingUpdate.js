    ...
    useEffect(() => {
        if (state.sendRequest) {
            async function UpdateProperty() {
                ...
                try {
                    await Axios.patch(
                        `https://listingbuddy-d88c1ed5b70e.herokuapp.com/api/listings/${props.listingData.id}/update/`,
                        formData
                    );
    ...
    return (
        ...
        >
            <form onSubmit={FormSubmit}>
                <Grid item container justifyContent="flex-start" marginBottom={'3rem'}>
                    <Typography variant="h4" fontWeight={500}>UPDATE LISTING</Typography>
                </Grid>
                ...
                <Grid
                    ...
                    flexDirection={'row'}
                    gap={'10px'}
                    style={{ marginTop: "11rem", marginLeft: "auto", marginRight: "auto" }}
                >
                    <Button
                        variant="contained"
                        type="submit"
                    ...
                    <Button style={{backgroundColor: 'transparent', border: '1px solid black', color: 'black'}} onClick={props.closeDialog}>
                        CANCEL
                    </Button>
                </Grid>
            </form>
